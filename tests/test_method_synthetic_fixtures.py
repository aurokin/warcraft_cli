...
def test_synthetic_class_guide_fixture_contract() -> None:
...
def test_synthetic_profession_guide_fixture_contract() -> None:
...
def test_synthetic_delve_guide_fixture_contract() -> None:
    payload = parse_guide_page(
...
def test_synthetic_reputation_guide_fixture_contract() -> None:
    payload = parse_guide_page(
...
def test_synthetic_article_guide_fixture_contract() -> None:
    payload = parse_guide_page(
...
def test_synthetic_unsupported_index_fixture_contract() -> None:
    payload = parse_guide_page(
